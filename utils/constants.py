...
PET_IMAGE_URLS = {
    ...
    "Sunmoth": "https://placehold.co/100x100/DAA520/ffffff?text=Moth",
...
PET_DESCRIPTIONS = {
    ...
    "Sunmoth": "Its wings shimmer with iridescent dust, reflecting the sunlight. Sunmoths flit gracefully through the sun-dappled canopy.",
