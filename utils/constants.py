...
PET_IMAGE_URLS = {
    ...
    "Glimmerva": "https://placehold.co/100x100/DAA520/ffffff?text=Glimmerva",
    "Grimweave": "https://placehold.co/100x100/4B0082/ffffff?text=Weaver",
    "Moonwisp": "https://placehold.co/100x100/9370DB/ffffff?text=Sprite",
...
PET_DESCRIPTIONS = {
    ...
    "Glimmerva": "A soft-bodied larva covered in fine, glowing scales. It clings to sun-warmed leaves, pulsing faintly with light when disturbed.",
    "Grimweave": "A reclusive spider that spins almost invisible webs between the shadowed branches.",
    "Moonwisp": "An elusive, ethereal being formed from pure moonlight and forest magic. It dances among the Moonpetals.",
