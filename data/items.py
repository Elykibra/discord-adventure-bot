...
ITEMS = {
    ...
    "weeping_sap": {
        "name": "Weeping Sap",
        "description": "A vial of bruised-purple sap, faintly warm and faintly luminous. It doesn't behave like sap should — it moves a little, even still.",
        "dropdown_description": "Crafting material from the Weeping Root.",
        "menu_description": "Bruised-purple sap drawn from Withering-Marked wildlife. Future crafting use.",
        "category": "Crafting Materials",
        "price": 14,
        "actions": ["drop", "inspect"],
    },
    "stoneplate_shard": {
        "name": "Stoneplate Shard",
        "description": "A piece of calcified bark, cool and smooth to the touch. It doesn't regrow, and it doesn't weather.",
        "dropdown_description": "Crafting material from the Weeping Root.",
        "menu_description": "A shard of calcified plating shed by Stillroot. Future crafting use.",
        "category": "Crafting Materials",
        "price": 14,
        "actions": ["drop", "inspect"],
    },
    "veinglow_essence": {
        "name": "Veinglow Essence",
        "description": "A small vial of something drawn from a Veinglow. It tastes neutral against the tongue — somehow, against everything else down here. Not a cure. A clue.",
        "dropdown_description": "Quest item — research material.",
        "menu_description": "A rare essence drawn from a Veinglow. Untouched by the Gloom. Someone researching Gloom Sickness would want this.",
